...
object Command {
  ...
  case class SaveConfiguration(data: model.FlowConfiguration.New) extends Command with Data[model.FlowConfiguration.New]
  case class UpdateConfiguration(data: model.FlowConfiguration)   extends Command with Data[model.FlowConfiguration]
