...
import {addNewType as addNewControllerType, setTypes as setControllerTypes} from './controller-types/actions'
import {addNewType as addNewPeripheryType, setTypes as setPeripheryTypes} from './periphery-types/actions'
...
export const InventoryManagement = () => {
    ...
    registerCallback('peripheryType', addNewPeripheryType)
    registerCallback('controllerType', addNewControllerType)
    registerCallback('controllerTypes', setControllerTypes)
    registerCallback('peripheryTypes', setPeripheryTypes)
